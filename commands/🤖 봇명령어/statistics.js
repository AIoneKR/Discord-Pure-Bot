...
embed.addField(`${emojil5}` + `Servers`, `${client.guilds.cache.size}`, true)
embed.addField(`${emojil3}` + `Users`, `${client.users.cache.size}`, true)
embed.addField(`${emojil6}` + `Channels`, `${client.channels.cache.size}`, true)
embed.addField(`${emojil4}` + `Commands`, `${client.commands.size}`, true)
